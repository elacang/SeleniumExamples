...
public class stepDefinition {
	...
	public void the_user_should_be_redirected_to(String arg1) throws Throwable {
		WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='content']")));
		Assert.assertEquals(arg1, driver.getCurrentUrl());
	}

	@Then("^the user closes the web browser$")
	public void the_user_closes_the_web_browser() throws Throwable {
